...
| Foundation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | P-Reps                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <ul><li>Disable public endpoint(ctz.solidwallet.io and wallet.icon.foundation).</li><li>Transaction processing is disabled.</li><li>Stop all ICON1 citizens.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | <ul><li>If you are running a citizen node, stop it.</li></ul>                                                                                                                              |
| <ul><li>Send a transaction for a new revision (ICON2 Revision).</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | <ul><li>Vote on the proposal with preptools.</li><li>P-Reps can't vote on icon.community</li><li>Use preptools to change the endpoint to</li><li>P-Reps own ICON1 node and vote.</li></ul> |
| <ul><li>Wait for consensus proposal to be completed.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <ul><li>No action is required.</li></ul>                                                                                                                                                   |
| <ul><li>ICON1 node and Citizen node will suspend state.</li><li>CON2 node is changed to import_icon xxx finished state.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | <ul><li>ICON1(Citizen) node will suspend state.</li><li>ICON1 citizen node can’t generate the new block.</li><li>But it is possible to query the transactions.</li></ul>                   |
| <ul><li>Wait for all ICON2 nodes reach to the target.</li><li>ICON1 consensus will stop at the target.</li><li>ICON2 import will stop at the target</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | <ul><li>No action is required.</li></ul>                                                                                                                                                   |
| <ul><li>Enter the following command to confirm end of migration</li></ul><p><code>$ docker exec -it icon2-node goloop chain ls</code></p><p><code>[</code></p><p><code>  {</code></p><p><code>    "cid": "0x1",</code></p><p><code>    "nid": "0x1",</code></p><p><code>    "channel": "icon_dex",</code></p><p><code>    "state": "import_icon 40123455 finished",</code></p><p><code>    "height": 6830,</code></p><p><code>    "lastError": ""</code></p><p><code>  }</code></p><p><code>]</code></p><ul><li>Stop ICON2 migration task</li><li>Stop chain</li></ul><p><code>docker exec -it icon2-node goloop chain stop 0x1</code></p><ul><li>Then ICON2 will fall in <code>import_icon finished</code> status after erasing all temporary data.</li><li>To see the last block height, you need to stop again</li><li>Stop chain<br><br><code>docker exec -it icon2-node goloop chain stop 0x1</code><br></li><li>Start chain:<br><br><code>docker exec -it icon2-node goloop chain start 0x1</code></li></ul> | <ul><li>Wait and keep the icon1 citizen node</li></ul><p><br></p>                                                                                                                          |
| <ul><li>Switch the ICON2 network and Start ICON2 consensus</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | <ul><li>Wait and keep the icon1 citizen node</li></ul>                                                                                                                                     |
| <ul><li>PRep completed migrations.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | <ul><li>Wait and keep the icon1 citizen node</li></ul>                                                                                                                                     |
| <ul><li>Foundation will make backup data with backup node(ICON2 Real data).</li><li>Let you know, If we ready.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | <ul><li>Monitor whether consensus is reached and blocks are created</li></ul><p> </p>                                                                                                      |
| <ul><li>Announce a successful migration.</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | <ul><li>Shut down old ICON1 server.</li></ul>                                                                                                                                              |
