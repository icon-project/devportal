...
- [Deployment Instructions](./btp-development-instructions.md#deployment-instructions)
  ...
  - [Deploy Smart Contracts (ICON)](./deploy-smart-contracts-icon.md#smart-contracts-on-icon-deployment)
  ...
  - [Deploy Smart Contracts (Moonriver)](./deploy-smart-contracts-moonriver.md#smart-contracts-on-moonriver-deployment)
  ...
  - [BMRs Setup](./relays-setup.md#btp-message-relay-bmr-setup)
    - [Generate Keystores](./relays-setup.md#2-generate-keystores)
  ...
  - [Deploy BMRs](./deploy-relays.md#btp-message-relay-bmr-deployment)
