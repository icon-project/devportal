...
![](../../.gitbook/assets/1c0df5c-state_diagram.png)
...
Please refer to [T-Bears](../../tbears/installation.md) and install it.

#### Wallet

You can create a wallet in ICONex.

ICONex can be accessed in the Wallet menu of [https://iconrepublic.org/](https://iconrepublic.org/) and installed as a chrome extension. You can deposit a certain amount of ICX, and transacton fee will be deducted from your balance. After creating the wallet, you can back up the keystore file, which will be used when deploying the SCORE from T-Bears CLI.

![](../../.gitbook/assets/e983d98-wallet_backup.png)
...
![](../../.gitbook/assets/975dd33-wallet_load.png)

#### Tracker

ICON network provides a tracker \([https://tracker.icon.foundation/](https://tracker.icon.foundation/)\), which enables you to access the status of any block and transaction.

![](../../.gitbook/assets/0011ad2-tracker.png)
...
![](../../.gitbook/assets/3d7c085-deploy_1.png)
...
![](../../.gitbook/assets/cf9a8ff-deploy_2.png)
...
![](../../.gitbook/assets/4197dd1-score_active.png)
...
You can execute `tbears deploy` command with -m option, or set deploy mode to 'update' in 'tbears\_cli\_config.json' file.
...
![](../../.gitbook/assets/d5c07fb-deploy_update.png)
...
![](../../.gitbook/assets/d984c54-deploy_update_contract.png)
...
![](../../.gitbook/assets/5bff864-rejected_1.png)

You can see the detailed reason of rejection in reject transaction.

![](../../.gitbook/assets/731f245-rejected_2.png)
...
![](../../.gitbook/assets/2c6639a-deploy_other_owner.png)
