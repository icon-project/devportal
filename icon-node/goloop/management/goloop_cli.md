...
| Command | Description |
| :--- | :--- |
| [goloop rpc sendtx call](goloop_cli.md#goloop-rpc-sendtx-call) | SmartContract Call Transaction |
| [goloop rpc sendtx deploy](goloop_cli.md#goloop-rpc-sendtx-deploy) | Deploy Transaction |
| [goloop rpc sendtx raw](goloop_cli.md#goloop-rpc-sendtx-raw) | Send transaction with json file |
| [goloop rpc sendtx raw2](goloop_cli.md#goloop-rpc-sendtx-raw2) | Send transaction with json file just timestamp & sign |
| [goloop rpc sendtx transfer](goloop_cli.md#goloop-rpc-sendtx-transfer) | Coin Transfer Transaction |
...
| Command | Description |
| :--- | :--- |
| [goloop server save](goloop_cli.md#goloop-server-save) | Save configuration |
| [goloop server start](goloop_cli.md#goloop-server-start) | Start server |
...
| Command | Description |
| :--- | :--- |
| [goloop system backup](goloop_cli.md#goloop-system-backup) | Manage stored backups |
| [goloop system config](goloop_cli.md#goloop-system-config) | Configure system |
| [goloop system info](goloop_cli.md#goloop-system-info) | Get system information |
| [goloop system restore](goloop_cli.md#goloop-system-restore) | Restore chain from a backup |
...
| Command | Description |
| :--- | :--- |
| [goloop system backup ls](goloop_cli.md#goloop-system-backup-ls) | List current backups |
...
| Command | Description |
| :--- | :--- |
| [goloop user add](goloop_cli.md#goloop-user-add) | Add user |
| [goloop user ls](goloop_cli.md#goloop-user-ls) | List users |
| [goloop user rm](goloop_cli.md#goloop-user-rm) | Remove user |
